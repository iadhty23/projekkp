								...
								<div class='col-sm-4'></div>
									<div class='col-sm-5'>
										<table class='table table-bordered'>
											...
											<tr>
													<td>Umur</td>
													<td ><input type="text" id="telpon" name="umur" onkeypress="return isNumber(event)" class='form-control' value="<?= $mhs["umur"]; ?>"></td>
											</tr>
													...
													<tr>
														...
														<td>
															<div class="form-group">
																<div class="col-sm-6">
																	<input type="radio" name="jenis"   value='Laki-laki'<?php if ($mhs["jenis"]=='Laki-laki') echo 'checked' ?>> Laki - Laki &nbsp;
																	<input type="radio" name="jenis"   value='Perempuan'<?php if ($mhs["jenis"]=='Perempuan') echo 'checked' ?> > Perempuan
																</div>
															  </div>	
														</td>
													</tr>
												...
												<tr>
													...
													<td>
														<select class="form-control" name="jabatan">
															<option><?php echo $mhs["jabatan"]; ?></option>
												...
												<tr>
													...
													<td>
														<select class="form-control" name="masakerja">
															<option><?php echo $mhs["masakerja"]; ?></option>
...
<br>
		<a href="../index_pegawai.php" class="btn btn-primary">
